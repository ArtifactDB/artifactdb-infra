...
then
    ...
    for tg_arn in `aws resourcegroupstaggingapi get-resources --resource-type-filters elasticloadbalancing:targetgroup --tag-filters Key=OwnedBy,Values=${cluster_name} Key=ArtifactDBIngress,Values=true --query ResourceTagMappingList[].ResourceARN --output text`
    do
